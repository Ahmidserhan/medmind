        ...
        <div className="space-y-6">
          ...
          <div className="relative rounded-2xl p-6 sm:p-8 bg-gradient-to-br from-[#0F3D73] via-[#0B2F59] to-[#082344] text-white shadow-xl overflow-hidden">
            ...
            <div className="relative z-10">
              <h1 className="text-2xl sm:text-3xl font-bold mb-2">Exams & Tests</h1>
              <p className="text-white/80 text-sm sm:text-base">Schedule your exams, track locations, and manage preparation time</p>
            </div>
          </div>
